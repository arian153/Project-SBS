...
namespace Engine
{
    ...
    {
        m_friction_map.emplace(
                               static_cast<size_t>(Physics::Material::WOOD.type) + static_cast<size_t>(
                                   Physics::Material::WOOD.type), FrictionCoefficient(0.3f, 0.2f));
        m_friction_map.emplace(
                               static_cast<size_t>(Physics::Material::CONCRETE.type) + static_cast<size_t>(
                                   Physics::Material::WOOD.type), FrictionCoefficient(0.5f, 0.4f));
